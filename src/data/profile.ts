export const profile = {
  name: 'Rafael Varela',
  title: 'Desenvolvedor Web focado em WordPress, Front-end e soluções digitais reais.',
  location: 'Recife/PE',
  summary:
    'Profissional de tecnologia com experiência em desenvolvimento front-end, WordPress/PHP, sistemas web e gestão técnica de projetos.',
